...
transfer_def!(MutTransfer, init, WriteBuffer, write_buffer, mut;);
transfer_def!(ConstTransfer, init_const, ReadBuffer, read_buffer;
    ...
    <PERIPHERAL as TargetAddress<PeripheralToMemory>>::MemSize: Copy,
{
    ...
    pub fn elements_available(&mut self) -> usize {
        let blen = unsafe { self.transfer.buf.write_buffer().1 };
    ...
    STREAM: traits::Stream,
{
    ...
    where
        ...
        BUF: WriteBuffer<Word = <PERIPHERAL as TargetAddress<MemoryToMemory<T>>>::MemSize>;
    ...
    where
        PERIPHERAL: TargetAddress<PeripheralToMemory>,
        BUF: WriteBuffer<Word = <PERIPHERAL as TargetAddress<PeripheralToMemory>>::MemSize>;
    ...
    where
        ...
        BUF: ReadBuffer<Word = <PERIPHERAL as TargetAddress<MemoryToPeripheral>>::MemSize>;
    ...
    where
        ...
        &'static mut [<PDST as TargetAddress<MemoryToPeripheral>>::MemSize; 1]:
            WriteBuffer<Word = <PSRC as TargetAddress<PeripheralToMemory>>::MemSize>;
