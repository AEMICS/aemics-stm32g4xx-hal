pub use hal_old::digital::v2::*;
pub use hal_old::prelude::*;

pub use hal_old::adc::OneShot as _;
pub use hal_old::watchdog::Watchdog as _;
pub use hal_old::watchdog::WatchdogEnable as _;
